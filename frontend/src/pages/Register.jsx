...
export default function Register() {
  ...
  return (
    <div className="min-h-screen bg-[#0a0a0f] flex items-center justify-center px-4">
      <div className="fixed top-1/3 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[500px] h-[400px] bg-[#8b5cf6]/8 rounded-full blur-[120px] pointer-events-none" />
      ...
      >
        ...
        <div className="bg-[#12121a] border border-white/[0.08] rounded-2xl p-8">
          <div className="text-center mb-8">
            ...
            <p className="text-gray-400 text-sm">Start analyzing stocks with AI</p>
          </div>
          ...
          <p className="text-center text-gray-400 text-sm mt-6">
            ...
            <Link to="/login" className="text-[#818cf8] hover:text-[#6366f1] transition-colors font-medium">
              Sign in
            </Link>
          </p>
        </div>
