  ...
  return (
    <div className="min-h-screen bg-[#0a0a0f] overflow-hidden">
      ...
      <section className="relative z-10 max-w-5xl mx-auto text-center px-6 pt-16 md:pt-28 pb-20">
        ...
        >
          Advanced technical indicators, real-time market data, and LSTM deep
          learning forecasts — all in one beautiful platform.
        </motion.p>
        <motion.div
          initial="hidden"
          animate="visible"
      ...
      <footer className="relative z-10 border-t border-white/[0.05] py-8 text-center text-gray-500 text-sm">
        <p>
          © 2026 StockSense. College Project — AI Stock Analysis & Forecasting
          Platform.
        </p>
      </footer>
    </div>
